 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Eric Zhu");
		  toPrint += p1.toString("ezhu31");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Anna Bonatz");
		  toPrint += p2.toString("abonatz3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
<<<<<<< HEAD
		  Person3 p3 = new Person3(“Grace Hansen“);
		  toPrint += p3.toString("ghansen33”);
=======
		  Person3 p3 = new Person3("Grace Hansen");
		  toPrint += p3.toString("ghansen3");
>>>>>>> 3a23041d071cec8008c002d31ba3d643cfe19ec8
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jessie Tepper");
                  toPrint += p4.toString("jtepper7");
